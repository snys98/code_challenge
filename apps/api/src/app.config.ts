...
export const AppConfig = {
  ...
  mongoose: {
    mongoUri: process.env.MONGO_URI || "mongodb://mongo.dev.challenge:27017/challenge",
  } as MongooseModuleConfig,
  logger: {
    esNode: process.env.ES_NODE || 'http://elasticsearch.dev.challenge:9200',
    apmUrl: process.env.APM_URL || 'http://apm-server.dev.challenge:8200',
    esUsername: process.env.ES_USERNAME || 'elastic',
    esPassword: process.env.ES_PASSWORD || 'challenge123456',
  },
  redis: {
    url: process.env.REDIS_URL || "redis://redis.dev.challenge:6379/0",
